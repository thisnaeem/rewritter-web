    ...
    <div className="w-full py-20 lg:py-40">
      <div className="container mx-auto">
        <div className="flex flex-col gap-4">
          <div>
            <Badge>Chrome Extension Comparison</Badge>
          </div>
          <div className="flex gap-2 flex-col">
            ...
            <p className="text-lg max-w-xl lg:max-w-xl leading-relaxed tracking-tight text-muted-foreground">
              See how Rewritter compares to other grammar checking extensions. Drag the slider to compare features and interface.
            </p>
          </div>
          <div className="pt-12 w-full">
            ...
            >
              ...
              <Image
                ...
                alt="Rewritter Chrome Extension Interface"
                width={800}
                height={450}
                priority
              ...
              <Image
                ...
                alt="Other Grammar Extension Interface"
                width={800}
                height={450}
                priority
